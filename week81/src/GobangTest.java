...
public class GobangTest {
    public static void main(String[] args) {
        ...
        List<String> lines = gobangChess.readFileByFileReader("D:\\大学学习\\计算机\\first programe\\week81\\chessboard");
//        List<String> lines = gobangChess.readFileByFileReader("chessboard.txt");
        ...
        gobangChess.readFileByByte("D:\\大学学习\\计算机\\first programe\\week81\\bytes");
